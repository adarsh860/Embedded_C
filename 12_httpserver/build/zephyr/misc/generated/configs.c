...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_BUF_DATA_SIZE, 1500);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_DHCPV4_LOG_LEVEL_DBG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_DHCPV4_LOG_LEVEL, 4);
